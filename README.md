...
> `backend/data/custom_ipo_data.json` ve `backend/data/recent_outcomes.json` artık okunmuyor.
> Katılımcı sayısı doğrudan kaynaktan geldiği için elle giriş gerekmiyor; gerçekleşme
> önbelleği de veritabanına taşındı. Bu dosyalar silinebilir.
