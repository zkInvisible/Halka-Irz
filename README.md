...
- Bedelsiz sermaye artırımı yapan hisselerde fiyat kaynağı bütün geçmişi yeni pay
  adedine böler. Seriler nominale geri çevrilir; arz→bugün getirisi ise artan lot
  adedine göre hesaplanır. Kaynak bir bedelsizi kaydetmemişse bu düzeltme yapılamaz —
  ilk seans kapanışı borsanın taban limitinin altında kalıyorsa kayıt uydurulmaz,
  nedeni belirtilerek atlanır.
