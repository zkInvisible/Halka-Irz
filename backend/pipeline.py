...
class RefreshPipeline:
    ...
    def _build_historical_offers(outcomes: list[dict[str, Any]]) -> list[dict[str, Any]]:
        ...
        outcome_keys = (
            ...
            "max_limit_up_streak", "max_limit_down_streak", "opening_limit_down_streak",
            "trough_close_tl", "trough_return_pct", "trough_date", "trough_session",
            "first_sellable_return_pct", "first_sellable_session", "still_limit_down_locked",
            "limit_up_method", "limit_down_method", "latest_close_tl", "latest_close_date",
            ...
            "split_factor_since_listing", "split_events", "split_method",
