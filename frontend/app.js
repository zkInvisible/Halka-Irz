...
function getFilteredHistory() {
  ...
  if (sk === 'tavan-desc')  offers.sort((a,b) => (b.historical_outcome?.max_limit_up_streak??-1)-(a.historical_outcome?.max_limit_up_streak??-1));
  if (sk === 'tavan-asc')   offers.sort((a,b) => (a.historical_outcome?.max_limit_up_streak??-1)-(b.historical_outcome?.max_limit_up_streak??-1));
